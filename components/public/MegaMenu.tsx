...
const ITEMS: Item[] = [
  {
    ...
    desc_es: "Aéreo · Marítimo (FCL/LCL) · Terrestre.",
    desc_en: "Air · Sea (FCL/LCL) · Land.",
  },
  {
    ...
    desc_es: "Áreas exclusivas y compartidas.",
    desc_en: "Exclusive and shared areas.",
  },
  {
    ...
    desc_es: "Operadores logísticos.",
    desc_en: "Logistics operators.",
  },
  {
    ...
    desc_es: "Mudanza internacional.",
    desc_en: "International moving.",
  },
];

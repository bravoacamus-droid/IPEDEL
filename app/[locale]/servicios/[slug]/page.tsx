...
const CONTENT: Record<Slug, ServiceContent> = {
  ...
  internacional: {
    eyebrow_es: "Servicios IPEDEL",
    eyebrow_en: "IPEDEL Services",
    title_es: "Mudanza internacional",
    ...
    intro_es: [
      "Iniciamos con una reunión para estimar el volumen, peso y requerimientos específicos del embarque, atendiendo las consultas e inquietudes del cliente.",
      "Una vez reunida la información pertinente, presentamos al cliente un presupuesto para el traslado de sus pertenencias, orientándolo sobre los procedimientos a seguir.",
    ],
    intro_en: [
      "We begin with a meeting to estimate the volume, weight, and specific requirements of the shipment, addressing the client's questions and concerns.",
      "Once the pertinent information is gathered, we present the client with a quote for the moving of their belongings, guiding them through the procedures to follow.",
    ],
    bullets_title_es: "Características del servicio",
    bullets_title_en: "Service Features",
    bullets: [
      {
        icon: Container,
        es: "Door to Port — desde su domicilio en el país de origen al puerto de destino",
        en: "Door to Port — from your home in the origin country to the destination port",
      },
      {
        icon: HomeIcon,
        es: "Door to Door — desde su domicilio en el país de origen a su nueva dirección",
        en: "Door to Door — from your home in the origin country to your new address",
      },
      {
        icon: PackageOpen,
        es: "Room to Room — embalaje en origen, desembalaje y acomodo en destino",
    ...
    highlights: [
      {
        ...
        title_es: "Embalaje",
        title_en: "Packing",
        desc_es: "Materiales y procedimientos adecuados para el embalaje de su carga.",
        desc_en: "Adequate materials and procedures for the packing of your cargo.",
        bullets_es: [],
        bullets_en: [],
      },
      {
        ...
        desc_es: "Orientación sobre documentos y requisitos para su mudanza internacional.",
        desc_en: "Guidance on documents and requirements for your international move.",
        bullets_es: [],
        bullets_en: [],
      },
      {
        icon: Route,
        title_es: "Coordinación",
        title_en: "Coordination",
        desc_es: "Coordinación del embarque desde el origen hasta su punto de entrega.",
        desc_en: "Coordination of the shipment from origin to its delivery point.",
        bullets_es: [],
        bullets_en: [],
      },
    ],
